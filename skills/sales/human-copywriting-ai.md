---
name: human-copywriting-ai
description: Comprehensive system for producing marketing copy that passes human detection while maintaining brand authenticity. Triggers when users need help writing AI-generated content that sounds human, eliminating AI tells from copy, capturing authentic brand voices, preventing repetitive patterns, or implementing quality control for copywriting. Includes banned word lists, voice extraction methodology, anti-repetition frameworks, and the 16-point naturalness scorecard.
---
...
| Free from waffle, hyperbole, cliches, and AI buzzwords | /1 |
...
Run through Originality.ai or GPTZero. Flag if AI probability exceeds 30%.
...
|------|----------|----------|
| Originality.ai | AI detection | Pre-delivery quality check |
